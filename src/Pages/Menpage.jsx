...
function Menpage() {
    ...
    // console.log(pro);
    const Menproducts = products.filter((value) => value.gender === "Male")
    const [product] = useState(Menproducts);
        ...
        <>
         <div className='pt-16'>
            <div className='flex flex-col items-center justify-center h-48 bg-[#EFF3EA] text-black max-md:h-36'>
                    <h1 className='text-lg max-md:text-sm'>Men Products</h1>
                    <p className='text-sm max-md:text-[10px]'>home &gt; Men</p>
             </div>
